...
<body>
    <div class="container text-center">
        ...
        <!-- CONTENT -->
        <section class="my-5">
            <h2 class="display-6 fw-light">Editar usuario</h2>
            <form method="post" id="add_user" name="add_user" action="<?php echo base_url('/admin/actualizar_usuario') ?>">
                <div class="form-group row justify-content-center my-4">
                    <div class="col-lg-6 col-md-8">
                        <input type="text" name="user" class="form-control" placeholder="<?php echo $user['Usuario']?>">
                    </div>
                </div>
                ...
                <div class="form-group row justify-content-center my-4">
                    <div class="col-lg-6 col-md-8">
                        <input type="text" name="password" id="password" class="form-control" placeholder="Introduce la nueva contraseña">
                    </div>
                </div>

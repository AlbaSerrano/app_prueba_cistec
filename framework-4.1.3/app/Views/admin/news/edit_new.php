...
<body>
    <div class="container text-center">
        ...
        <!-- CONTENT -->
        <section class="my-5">
            <h2 class="display-6 fw-light">Editar noticia</h2>
            <form method="post" id="add_category" name="add_category" action="<?php echo base_url('/admin/actualizar_noticia') ?>">

                <div class="form-group row justify-content-center my-4">
                    <div class="col-lg-6 col-md-8">
                        <input type="text" name="headline" class="form-control" placeholder="<?php echo $new['Titular'] ?>">
                    </div>
                </div>
                <div class="form-group row justify-content-center my-4">
                    <div class="col-lg-6 col-md-8">
                        <textarea name="body" class="form-control" placeholder="<?php echo $new['Cuerpo'] ?>"></textarea>
                    </div>
                </div>
                <div class="form-group row justify-content-center my-4">
                    <div class="col-lg-6 col-md-8">

...
<body>
    <div class="container text-center">
        ...
        <!-- CONTENT -->
        <section class="my-5">
            <h2 class="display-6 fw-light">Crear categoría nueva</h2>
            <form method="post" id="add_category" name="add_category" action="<?php echo base_url('/admin/guardar_categoria') ?>">

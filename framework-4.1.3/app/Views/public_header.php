...
<div class="row justify-content-center align-items-center text-center fw-light my-5 display-5">
    ...
    <div class="col-2"><img src="<?= base_url() ?>/assets/images/news.png" class="w-50"></div>
    <div class="col-6">
        PRUEBA PHP CISTEC
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav m-auto mb-2 mb-md-0 text-uppercase fw-bold">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('/noticias/ultimas_noticias')?>">Últimas noticias</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('/noticias/categorias')?>">Categorías</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url()?>/eltiempo">Tiempo</a>
                </li>
            </ul>
            <!--/NAV-->
        </div>
